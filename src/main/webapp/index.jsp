	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<form class="form-inline my-2 my-lg-0" action="inicio" method="get">
			<input type="hidden" name="nombre" value=""> <input
				type="hidden" name="pmin" value="0"> <input type="hidden"
				name="pmax" value="0"> <input type="hidden"
				name="fabricante" value="0"> <input type="submit"
				value="Limpiar Filtro" class="btn btn-outline-warning">
		</form>
	...
	<main class="container">
		...
		<div class="card-content">
			...
			<c:forEach items="${productos}" var="p">
				<div class="card">
					<img src="http://via.placeholder.com/100x100" class="card-img-top"
						alt="...">
					<div class="card-body">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-inline my-2 my-lg-0" action="inicio" method="get">
						<input type="text" class="form-control" name="pmin"
							value="${formulario.precioMin}" placeholder="Precio Mínimo">
						<input type="text" class="form-control" name="pmax"
							value="${formulario.precioMax}" placeholder="Precio Máximo">
						<input type="hidden" name="fabricante"
							value="${formulario.idFabricante}"> <input type="hidden"
							name="nombre" value="${formulario.nombre}"> <input
							class="submit" type="submit" value="Filtrar">
					</form>
